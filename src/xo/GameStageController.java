...
public class GameStageController {
	...
	@FXML private void gameBtn00_Click() {
		//System.out.println("Kliknieto 00!");
		if(turn) {
			...
			//consumer.receiveQueueMessagesAsynch(act.getGameChar() + "message", "yes");
		}			
	}
	
	@FXML private void gameBtn01_Click() {
		//System.out.println("Kliknieto 01!");
		if(turn) {
	...
	@FXML private void gameBtn02_Click() {
		//System.out.println("Kliknieto 02!");
		if(turn) {
	...
	@FXML private void gameBtn10_Click() {
		//System.out.println("Kliknieto 10!");
		if(turn) {
	...
	@FXML private void gameBtn11_Click() {
		//System.out.println("Kliknieto 11!");
		if(turn) {
	...
	@FXML private void gameBtn12_Click() {
		//System.out.println("Kliknieto 12!");
		if(turn) {
	...
	@FXML private void gameBtn20_Click() {
		//System.out.println("Kliknieto 20!");
		if(turn) {
	...
	@FXML private void gameBtn21_Click() {
		//System.out.println("Kliknieto 21!");
		if(turn) {
	...
	@FXML private void gameBtn22_Click() {
		//System.out.println("Kliknieto 22!");
		if(turn) {
